        ...
        <div className="Section2" id='k'>
          ...
          <div className="VideoS2Div">
            <div className='YellowLine'>
              {
                Video ? <video src={Video} className='Video' autoPlay loop /> : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}><TailSpin
                  height="30"
                  width="30"
                  color="#4fa94d"
