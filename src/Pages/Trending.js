  ...
  return (Allindices.length !== 0 &&
    ...
    <>
      ...
      <div className="OuterTrendingPage">
        <div
          className={`SearchIconTrendingPage ${
            focus ? "focusedborderradius" : ""
          }`}
        >
          <svg
            viewBox="0 0 30 25"
        ...
        {errorValue !== "gainerandlooser" ? (
          <>
            ...
            <select
              ...
              id=""
              className="optionIndices"
              onChange={handleindiceschangeTopGL}
            >
              {Allindices.map((data) => {
                return (
                  <option value={data.indexSymbol}>{data.indexSymbol}</option>
